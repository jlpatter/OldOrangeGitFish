...
module.exports = class SVGRow {
  ...
  getContextFunction() {
    ...
    return function(event) {
      ...
      const $mergeBtn = $('<button type="button" class="btn btn-secondary btn-sm square-border"><i class="bi bi-arrows-angle-contract"></i> Merge</button>');
      $mergeBtn.click(function() {
        ipcRenderer.send('git-merge-message', self.sha);
      });
      $contextMenu.append($mergeBtn);

      const $softResetBtn = $('<button type="button" class="btn btn-secondary btn-sm square-border"><i class="bi bi-arrow-clockwise"></i> Soft Reset to Here</button>');
      $softResetBtn.click(function() {
        ipcRenderer.send('git-reset-soft-message', self.sha);
      });
      $contextMenu.append($softResetBtn);

      const $mixedResetBtn = $('<button type="button" class="btn btn-secondary btn-sm square-border"><i class="bi bi-arrow-clockwise"></i> Mixed Reset to Here</button>');
      $mixedResetBtn.click(function() {
        ipcRenderer.send('git-reset-mixed-message', self.sha);
      });
      $contextMenu.append($mixedResetBtn);

      const $hardResetBtn = $('<button type="button" class="btn btn-secondary btn-sm square-border"><i class="bi bi-arrow-clockwise"></i> Hard Reset to Here</button>');
